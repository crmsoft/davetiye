...
(function($, UNDEF){
	...
	/**
			...
			The testing function returns false when an error.blade is detected,
	...
	**/
			...
			$.each(a, function( i, v ){
				...
				// or if the test fails, throw an error.blade.
				if((v.r && (!o[i] && o[i] !== 0)) || ((o[i] || o[i] === 0) && !v.t(o,o[i],i))){
					...
					// Since 'error.blade' will prevent further script execution,
					// log the error.blade first.
