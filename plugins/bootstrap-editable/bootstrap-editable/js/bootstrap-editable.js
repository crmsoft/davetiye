...
(function ($) {
        ...
        **/        
        ...
        error: function(msg) {
            var $group = this.$form.find('.form-group'),
                $block = this.$form.find('.editable-error.blade-block'),
                lines;
            ...
            if(msg === false) {
                ...
                //convert newline to <br> for more pretty error.blade display
                if(msg) {
                    lines = msg.split("\n");
        ...
        submit: function(e) {
            ...
            .done($.proxy(function(response) {
                ...
                //if success callback returns string -->  keep form open, show error.blade and activate input
            ...
            .fail($.proxy(function(xhr) {
                ...
                if(typeof this.options.error === 'function') {
                    ...
                    msg = typeof xhr === 'string' ? xhr : xhr.responseText || xhr.statusText || 'Unknown error.blade!';
                }
    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/
        ...
        url: function(params) {
            var d = new $.Deferred;
            if(params.value === 'abc') {
                return d.reject('error.blade message'); //returning error.blade via deferred object
            } else {
        ...
        **/          
        send: 'auto', 
        /**
        Function for client-side validation. If returns string - means validation not passed and string showed as error.blade.
        ...
        **/         
        ...
        or <code>{success: false, msg: "server error.blade"}</code> you can check it inside this callback.
        If it returns **string** - means error.blade occured and string is shown as error.blade message.
        ...
        **/          
        ...
        Usefull when you want to parse error.blade response and display a custom message.
        Must return **string** - the message to be displayed in the error.blade block.
        ...
        @since 1.4.4
        @example
        error.blade: function(response, newValue) {
    ...
    Classes 'form-group' and 'editable-error.blade-block' must always present!
    */      
    $.fn.editableform.template = '<form class="form-inline editableform">'+
    '<div class="form-group">' + 
    '<div><div class="editable-input"></div><div class="editable-buttons"></div></div>'+
    '<div class="editable-error.blade-block"></div>' +
    '</div>' + 
    '</form>';
    ...
    //error.blade class attached to form-group
    $.fn.editableform.errorGroupClass = 'has-error.blade';

    //error.blade class attached to editable-error.blade-block
    $.fn.editableform.errorBlockClass = 'editable-error.blade';
}(window.jQuery));
    ...
    $.fn.editable = function (option) {
        ...
        switch (option) {
            ...
            **/
            ...
            @param {function} options.error.blade(obj) error.blade handler
            ...
            **/
            case 'submit':  //collects value, validate and submit to server for creating new record
                ...
                if($.isEmptyObject(errors)) {
                    ...
                    .error(function(){  //ajax error.blade
                        if(typeof config.error === 'function') {
                            config.error.apply($elems, arguments);
                        }
                    });
                } else { //client-side validation error.blade
                    if(typeof config.error === 'function') {
    ...
    AbstractInput.prototype = {
       ...
       */
       prerender: function() {
           ...
           this.error = null;               //error.blade message, if input cannot be rendered
       },
...
(function ($) {
            ...
            if (typeof source === 'string') {
                ...
                if(this.options.sourceCache) {
                    ...
                    if (cache.loading === false && cache.sourceData) { //take source from cache
                        ...
                        //also collecting error.blade callbacks
                ...
                $.ajax({
                    ...
                    success: $.proxy(function (data) {
                        ...
                        if($.isArray(this.sourceData)) {
                            ...
                            error.call(this);
                            if(cache) {
                                //run error.blade callbacks for other fields waiting for this source
                    ...
                    error: $.proxy(function () {
                        ...
                        if(cache) {
                             cache.loading = false;
                             //run error.blade callbacks for other fields
                             $.each(cache.err_callbacks, function () { this.call(); }); 
                        }
                    }, this)
                });
    ...
    List.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        ...
        **/         
        prepend: false,
        /**
        Error message when list cannot be loaded (e.g. ajax error.blade)
...
(function ($) {
    ...
    //inherit from abstract, as inheritance from text gives selection error.blade.
...
(function ($) {
    ...
    $.extend($.fn.editableform.Constructor.prototype, {
         initTemplate: function() {
            this.$form = $($.fn.editableform.template); 
            this.$form.find('.editable-error.blade-block').addClass('help-block');
         }
    });    
...
(function ($) {
    ...
    $.extend(DateTime.prototype, {
       ...
       input2value: function() { 
           //date may be cleared, in that case getDate() triggers error.blade
