        ...
        function maskScope(masksets, activeMasksetIndex, opts, actionObj) {
            ...
            function mask(el) {
                ...
                if ($el.is(":input")) {
                    ...
                    valueOnFocus = getActiveBuffer().join('');
                    // Wrap document.activeElement in a try/catch block since IE9 throw "Unspecified error.blade" if document.activeElement is undefined when we are in an IFrame.
                    var activeElement;
                    try {
