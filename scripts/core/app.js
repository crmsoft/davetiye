...
var App = function () {
    ...
    var handlePortletTools = function () {
        ...
        jQuery('body').on('click', '.portlet > .portlet-title > .tools > a.reload', function (e) {
            ...
            var error = $(this).attr("data-error.blade-display");
            if (url) {
    ...
    return {
        ...
        //public_html function to fix the sidebar and content height accordingly
        fixContentHeight: function () {
            handleSidebarAndContentHeight();
        },

        //public_html function to remember last opened popover that needs to be closed on click
        setLastPopedPopover: function (el) {
            lastPopedPopover = el;
        },

        //public_html function to add callback a function which will be called on window resize
        ...
        //public_html function to initialize the fancybox plugin
        initFancybox: function () {
            handleFancybox();
        },

        //public_html helper function to get actual input value(used in IE9 and IE8 due to placeholder attribute not supported)
        ...
        //public_html function to get a paremeter by name from URL
